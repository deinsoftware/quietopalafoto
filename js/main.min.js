...
/*Twitter*/ var loadHeight = function() {};
...
/*Facebook*/ var fbURL = 'https://www.facebook.com/';
...
/*jslint browser:true */ var _gaq = _gaq || [];
...
var filterData = function(data) {
  ...
  data = data.filter(
    (e) =>
      (new Date(e.date.alert) < Date.now() ||
        new Date(e.date.start) < Date.now()) &&
      (!e.date.end || Date.now() < new Date(e.date.end)),
  );
  return data;
};
...
function loadRestrictions() {
  if (restrictions && restrictions.level) {
    ...
    if (restrictions.level > 1) {
      ...
      $('#restrictions-title span').text(hash);
      var bike = [];
